...
parser.add_argument('-m', '--min_error', help='set minimum error threshold', default=0)
args=parser.parse_args()
epochs=int(args.epochs)
rate=float(args.rate)
hidden=int(args.hidden)
minError=float(args.min_error)
...
#    print(nnData)
    ...
    nn = NeuralNetwork.NeuralNetwork(epochs=epochs, hidden=hidden, learningRate=rate, minError=minError)
